...
const Footer = () => {
    // ... rest of the file stays same until the return
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "wasifghori71@gmail.com", path: 'mailto:wasifghori71@gmail.com', icon: MailIcon },
                { text: "+923092335781", path: 'https://wa.me/923092335781', icon: PhoneIcon },
                { text: "office no B/62 Mir Fazal Town , Latifabad, hyderabad", path: '#', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        { icon: FacebookIcon, link: "https://www.facebook.com/wasif.ghori.18" },
        { icon: InstagramIcon, link: "https://www.instagram.com/wasif_ghori/" },
        { icon: TwitterIcon, link: "https://x.com/wasifghori711" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/muhammad-wasif-dev/" },
    ]
        ...
        <>
            ...
            <footer className="mx-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Click</span>Cart<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to ClickCart, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © ClickCart All Right Reserved.
                </p>
            </div>
        </footer>
        </>
